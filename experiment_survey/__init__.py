...
class PageOne(Page):
    form_model = "player"
    form_fields = ["Q"+str(i) for i in range(1,8)]
    pass

class PageTwo(Page):
    form_model = "player"
    form_fields = ["Q"+str(i) for i in range(8,15)]
    pass
